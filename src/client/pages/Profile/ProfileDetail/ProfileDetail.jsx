    ...
    <>
      <div className="profile-detail-container">
        <div className="head" style={{ marginTop: "2rem" }}>
          ...
          <p>
            Quản lý thông tin hồ sơ của bạn và sử dụng thông tin trên Plan for
            Trips
          </p>
        </div>
        <div className="profile-card">
          ...
          <div className="profile-name" style={{ width: "100%" }}>
            <span style={{ fontSize: "20px", marginLeft: "20px" }}>{name}</span>
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-profile-custom">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <h3 style={{ fontWeight: "600" }}>Chỉnh sửa tên người dùng</h3>
              <InputFlied
